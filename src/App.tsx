...
function App() {
  ...
  const progressPages = isInclusion ? iePages : isShortestPath ? spPages : isLoop ? loopPages : isSort ? sortPages : isCmd ? cmdPages : poetryPages.includes(currentPage) ? poetryPages : []
